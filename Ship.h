...
public:
	...
	// static method that returns the current score
	static int GetScore() { return m_sScore; }

	// static method to increment the score tracker
	static void AddScore(int points) { m_sScore += points; }

	// static method to set score back to zero
	static void ResetScore() { m_sScore = 0; }
